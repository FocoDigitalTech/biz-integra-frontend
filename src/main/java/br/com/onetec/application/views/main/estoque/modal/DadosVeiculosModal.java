...
@Component
@UIScope
public class DadosVeiculosModal extends Dialog {
    ...
    private SetVeiculo veiculoModel;


    @Autowired
    public DadosVeiculosModal() {
    ...
    private void deleta(SetVeiculo veiculoModel) {
    ...
    public void setVeiculo(SetVeiculo item) {
        UI.getCurrent().access(() -> {
            this.veiculoModel = item;
            nome_veiculo.setValue(item.getNome_veiculo());
            marca_veiculo.setValue(item.getMarca_veiculo());
            modelo_veiculo.setValue(item.getModelo_veiculo());
            combustivel_veiculo.setValue(item.getCombustivel_veiculo());
            placa_veiculo.setValue(item.getPlaca_veiculo());
            datacompra_veiculo.setValue(item.getDatacompra_veiculo());
            nomeregistro_veiculo.setValue(item.getNomeregistro_veiculo());
            kminicial_veiculo.setValue(Double.valueOf(item.getKminicial_veiculo()));
            valorkm_veiculo.setValue(String.valueOf(item.getValorkm_veiculo()));
            datavenda_veiculo.setValue(item.getDatavenda_veiculo());
            valorvenda_veiculo.setValue(String.valueOf(item.getValorvenda_veiculo()));
            valorcompra_veiculo.setValue(String.valueOf(item.getValorcompra_veiculo()));
            renavam_veiculo.setValue(item.getRenavam_veiculo());
        });
    }
}