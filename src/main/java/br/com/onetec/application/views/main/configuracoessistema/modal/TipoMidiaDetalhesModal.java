...
public class TipoMidiaDetalhesModal extends Dialog {
    ...
    public void setTipoMidi(SetTipoMidia item) {
        this.setTipoMidia = item;
        decricaoField.setValue(item.getDescricao_tipomidia());
    }
}