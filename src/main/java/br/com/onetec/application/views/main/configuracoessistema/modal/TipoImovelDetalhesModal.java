...
@Component
@UIScope
public class TipoImovelDetalhesModal extends Dialog {
    ...
    public TipoImovelDetalhesModal() {
    ...
    private void save() throws Exception {
        ...
        SetTipoImovel dto = setTipoImovel;
    ...
    public void setTipoImove(SetTipoImovel item) {
        this.setTipoImovel = item;
        decricaoField.setValue(item.getDescricao_tipoimovel());
    }
}