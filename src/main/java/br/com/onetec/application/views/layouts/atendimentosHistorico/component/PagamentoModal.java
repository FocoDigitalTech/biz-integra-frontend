...
public class PagamentoModal {
    public static void openModalPagamento(SetPagamento item, PagamentoService pagamentoService, TipoPagamentoService tipoPagamentoService, SituacaoPagamentoService situacaoPagamentoService) {
