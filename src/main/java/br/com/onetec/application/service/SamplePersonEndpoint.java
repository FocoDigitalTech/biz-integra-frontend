package br.com.onetec.application.service;
...
public class SamplePersonEndpoint {
    ...
    private final br.com.onetec.application.services.SamplePersonService service;

    public SamplePersonEndpoint(br.com.onetec.application.services.SamplePersonService service) {
