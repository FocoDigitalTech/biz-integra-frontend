...
public class NotaFiscalService {
    ...
    public void delete(SetNotaFiscal item) throws Exception {
        try {
            Optional<SetNotaFiscal> optional = repository.findById(item.getId_notafiscal());
    ...
    public void update(SetNotaFiscal item) throws Exception {
        try {
            Optional<SetNotaFiscal> optional = repository.findById(item.getId_notafiscal());
            SetNotaFiscal entity = optional.get();
